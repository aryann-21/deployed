  ...
  return (
    <div className="flex flex-col md:flex-row h-full overflow-hidden bg-white">
      ...
      <div className="w-full md:w-1/2 p-4 md:p-6 flex flex-col justify-center items-center">
        ...
        <h2 className="text-gray-800 text-xl md:text-2xl lg:text-3xl font-bold mb-4 text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 w-full max-w-sm px-4">
          ...
          <div className="relative">
            ...
            />
            <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-500">
              <span className="material-icons text-sm sm:text-base">access_time</span>
            </span>
          </div>
          <div className="relative">
            <input
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="bg-yellow-400 text-base sm:text-lg text-black font-bold py-2 px-6 sm:px-10 rounded-md mt-4 hover:bg-yellow-500 transition duration-150"
            >
              See rides
            </button>
          </div>
